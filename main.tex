...
\begin{poster}{
    ...
    {\vspace{1em} Kulikov N.S. \footnotemark[1], Rumyantsev V.V. \footnotemark[1] \footnotemark[2], Zholudev M.S. \footnotemark[2], Utochkin V.V. \footnotemark[1] \footnotemark[2], Morozov S.V. \footnotemark[1]  \\ % Author names
    \footnotetext[1]{Lobachevsky State University of Nizhni Novgorod}
    \footnotetext[2]{Institute for Physics of Microstructures RAS}
